...
export const metadata = {
  ...
  description:
    "居住安全透視鏡用政府公開資料（水利署、地調所、環境部、健保署、USGS、OSM）計算 9 個居住安全維度，本頁說明每個維度的評分標準與資料出處。",
...
const SAFETY_DIMS: DimDoc[] = [
  ...
  },
  {
    ...
    rubric: [
      ...
      "全台 22 縣市皆可查詢。其他 21 縣市為水利署 24h 650mm 情境；臺北市使用 data.taipei 降雨積水模擬圖 130mm/h 短延時情境（各自為最壞情境）。",
    ],
    sources: [
...
const FAQS: Array<{ q: string; a: string }> = [
  ...
  {
    q: "我家在斷層帶上嗎？怎麼查？",
    a: "輸入你的地址，居住安全透視鏡會顯示距最近活動斷層的距離（單位公里）、斷層名稱與類型。距離小於 1 公里需要特別注意建築耐震標準，5 公里內仍屬中度風險範圍。",
  },
  {
    q: "我家會淹水嗎？",
    a: "全台 22 縣市皆可查詢。其他 21 縣市使用水利署 24 小時累積 650mm 最壞情境的淹水潛勢圖；臺北市使用 data.taipei 降雨積水模擬圖（130mm/h 短延時強降雨情境）。若你的地址落入潛勢區，會顯示預估淹水深度（如 0.3-0.5m）；不在潛勢區則分數較高。",
  },
  {
    q: "資料多久更新一次？",
  ...
  {
    q: "居住安全透視鏡會推薦房子或估價嗎？",
    a: "不會。居住安全透視鏡純粹是評估工具，不販售房屋資訊、不估價、不抽取任何仲介佣金。所有分數僅供參考，不構成購屋投資建議。",
  },
  {
    q: "為什麼我家總分不高但每個維度都不錯？",
    ...
    <div className="mx-auto max-w-3xl px-6 pb-24">
      ...
      <div className="mt-4">
        ...
        <p className="mt-4 text-base text-white/70">
          居住安全透視鏡用 9 個維度評估居住安全，分成 <strong className="text-white">安全層 (60%)</strong> 與
      ...
      <section className="mt-12">
        ...
        <ul className="mt-4 space-y-3 text-sm text-white/70">
          ...
          <li className="border-l-2 border-white/10 pl-4">
            <strong className="text-white">臺北市淹水情境不同</strong>：
            其他 21 縣市為水利署 24h 累積 650mm 最壞情境；臺北市資料來自 data.taipei 130mm/h
            短延時強降雨情境（兩者皆為各自最壞情境，但不完全等同）。
          </li>
          <li className="border-l-2 border-white/10 pl-4">
