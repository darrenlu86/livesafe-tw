...
export const metadata = {
  ...
  description:
    "LiveSafe.tw 用政府公開資料（水利署、地調所、環境部、健保署、USGS、OSM）計算 9 個居住安全維度，本頁說明每個維度的評分標準與資料出處。",
...
const FAQS: Array<{ q: string; a: string }> = [
  ...
  {
    q: "我家在斷層帶上嗎？怎麼查？",
    a: "輸入你的地址，LiveSafe.tw 會顯示距最近活動斷層的距離（單位公里）、斷層名稱與類型。距離小於 1 公里需要特別注意建築耐震標準，5 公里內仍屬中度風險範圍。",
  },
  {
    q: "我家會淹水嗎？",
  ...
  {
    q: "LiveSafe.tw 會推薦房子或估價嗎？",
    a: "不會。LiveSafe.tw 純粹是評估工具，不販售房屋資訊、不估價、不抽取任何仲介佣金。所有分數僅供參考，不構成購屋投資建議。",
  },
  {
    q: "為什麼我家總分不高但每個維度都不錯？",
    ...
    <div className="mx-auto max-w-3xl px-6 pb-24">
      ...
      <div className="mt-4">
        ...
        <p className="mt-4 text-base text-white/70">
          LiveSafe.tw 用 9 個維度評估居住安全，分成 <strong className="text-white">安全層 (60%)</strong> 與
